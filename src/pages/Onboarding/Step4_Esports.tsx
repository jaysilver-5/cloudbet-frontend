...
const items = [
  { name: 'Age of Empires', icon: SportsIcon },
  { name: 'FIFA', icon: EsportsIcon },
  { name: 'Call of Duty', icon: CasinoIcon },
  { name: 'NBA2K', icon: CasinoIcon },
  { name: 'Counter Strike', icon: EsportsIcon },
  { name: 'Dota 2', icon: CasinoIcon },
  { name: 'Free Fire', icon: SportsIcon },
  { name: 'Leagure of Legend', icon: CasinoIcon },
  { name: 'Rainbow Six', icon: EsportsIcon },
  { name: 'Rocket League', icon: SportsIcon },
  { name: 'Starcraft', icon: CasinoIcon },
  { name: 'Valorant', icon: EsportsIcon },
  { name: 'Warcraft', icon: CasinoIcon },
]

export default function Step4_Esports({
  selectedItems,
  onSelectItems,
}: {
